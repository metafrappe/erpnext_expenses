...
Upstream: https://github.com/kid1194/erpnext_expenses/commit/38e410ab8c50861d98a65905253ae4dc612edb47
Deployment branch: `version-16`. App: `expenses`.
...
and focused regressions via `bench --site TEST execute expenses.tests.v16_smoke.run --kwargs '{"app":"expenses"}'`.
